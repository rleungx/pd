...
LDFLAGS += -X "$(PD_PKG)/pkg/versioninfo.PDReleaseVersion=v7.1.1-serverless"
...
ifneq ($(DASHBOARD), 0)
	...
	LDFLAGS += -X "github.com/pingcap/tidb-dashboard/pkg/utils/version.PDVersion=v7.1.1-serverless"
